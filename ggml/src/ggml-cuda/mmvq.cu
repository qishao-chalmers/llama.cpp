...
static constexpr __device__ vec_dot_q_cuda_t get_vec_dot_q_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q4_K_RES_DRAFT: return vec_dot_q4_k_res_draft_q8_1;
        case GGML_TYPE_Q4_K_RES:       return vec_dot_q4_k_res_verify_q8_1;
...
static constexpr __device__ int get_vdr_mmvq(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q4_K_RES: return VDR_Q4_K_Q8_1_MMVQ;
...
static __global__ void mul_mat_vec_q(
    ...
    if constexpr (type == GGML_TYPE_Q4_K_RES) {
        if (fusion.q4_k_res_draft) {
            vec_dot_local = vec_dot_q4_k_res_draft_q8_1;
        } else {
            vec_dot_local = vec_dot_q4_k_res_verify_q8_1;
        }
    }
...
static void mul_mat_vec_q_switch_type(
    ...
    switch (type_x) {
        ...
        case GGML_TYPE_Q4_K:
            ...
            break;
        case GGML_TYPE_Q4_K_RES_DRAFT:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q4_K_RES_DRAFT>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
        case GGML_TYPE_Q4_K_RES:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q4_K_RES>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
...
void ggml_cuda_mul_mat_vec_q(
    ...
    fusion_local.q4_k_res_draft = ctx.q4_k_res_draft;
